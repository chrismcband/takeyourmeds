...
Bouncer[] bouncer = new Bouncer[3];
   ...
   void setup() {
     ...
     text("",0,0);
     textSize(24)
     bouncer[0] = new Ball(40,20,20, 1);
     bouncer[1] = new Ball(70,20,20, 2);
     bouncer[2] = new Ball(100,20,20, 3);
     bouncer[3] = new Ball(130,20,20, 4)
   }
   ...
   class Ball extends Bouncer
   {
     ...
     Ball(int x, int y, int r, int floor) {
       this.x = x;
       this.y = y;
       this.radius = r;
       this.floor = floor;
